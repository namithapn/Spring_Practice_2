package com.nami.spring.angularjs.learning.springangularjscurd.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.nami.spring.angularjs.learning.springangularjscurd.repository",
...
public class JpaConfiguration {
	 @Autowired
	    ...
	    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
	        ...
	        factoryBean.setPackagesToScan(new String[] { "com.nami.spring.angularjs.learning.springangularjscurd.model" });
